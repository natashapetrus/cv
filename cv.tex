...
\begin{minipage}[t]{0.31\linewidth}
  ...
  patents.npetr.us\enspace\faStar
\end{minipage}
\:\:\:\:\: % space between minipages
\begin{minipage}[c]{0.2\linewidth}
  ...
  \begin{tikzpicture}
    ...
    \includegraphics[width=1\linewidth]{assets/images/profile1.png}
  \end{tikzpicture}
\end{minipage}
...
\begin{tabular}{p{0.1\linewidth}p{0.05\linewidth}p{0.3\linewidth}p{0.45\linewidth}}
  ...
  \multicolumn{2}{p{0.75\linewidth}}{
    ...
    C\#,
    HTML +  CSS,
    JavaScript (jQuery, TypeScript, Vue.js, ReactJS, React Native, Knockout, AngularJS),
    SQL,
    LaTeX,
    MATLAB,
    C,
...
%% Geniuslink: Full-Stack Engineer
\vspace{7px}
...
\quad 
\textcolor{brilliant-azure}{[ patent number: US11828802B2 ]}
\\
